document.addEventListener('DOMContentLoaded', () => {
  ...
  // We'll replace aggregator warnings with a generic, network-based message:
  ...
  // Instead of aggregator warnings, build a generic fallback from "network" data
  function fetchWarnings(symbol) {
    return fetch(`${BACKEND_URL}/api/get_currency?symbol=${symbol.toLowerCase()}`)
      ...
      .then(d => {
        ...
        // Build a small pill with the relevant background color:
