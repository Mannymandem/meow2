/***************************************************************
 * main.js - Final with Min vs. Max logic 
 * 
 * 1) #exchange-modal-container => addresses + deposit steps
 * 2) #tracking-modal-container => exact deposit replicate
 * 
 * CHANGES:
 *   - parseErrorDescription(errMsg, userAmt) checks aggregator error for "Min:" & "Max:"
 *     and compares userAmt to decide which message to show.
 *   - We now call parseErrorDescription(...) as parseErrorDescription(d.error, fromAmt)
 ***************************************************************/
document.addEventListener('DOMContentLoaded', () => {
  ...
  function updateAmounts(){
    ...
    fetch(url)
      ...
      .then(d=>{
        if(d.error){
          // Now pass user’s fromAmt into parseErrorDescription:
