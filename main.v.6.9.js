 ...
 * 
 * CHANGES:
 *   - "Deposit step" polling still uses /api/status/<agg_id>
 *   - "Tracking modal" now calls /api/tracking/<agg_id>", so we can get
 *     address_from/address_to for display.
 *   - RESTORES the old search code for the dropdown so it filters properly.
 ***************************************************************/
