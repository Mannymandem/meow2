  ...
  if(addressesConfirmBtn){
    addressesConfirmBtn.addEventListener('click',()=>{
      ...
      .then(d=>{
        ...
        // QR: Generate with URI scheme based on the relevant deposit currency.
        if(qrcodeContainer && d.deposit_address){
          qrcodeContainer.innerHTML='';
          // Determine deposit currency: if crypto_to_xmr, then the deposit is for the crypto sent; otherwise XMR.
