/***************************************************************
 * main.js - Cleaned up version for smooth performance.
 * 
 * CHANGES:
 *  - Removed all approximation ("~") logic.
 *  - Removed aggregator-provided image logic; always using ImageKit fallbacks.
 *  - Retained core functionality: dropdown positioning, exchange, polling, and tracking.
 ***************************************************************/
document.addEventListener('DOMContentLoaded', () => {
   ...
   ****************************************************/
  function renderCryptoButton(btn, symbol, _, network) {
    // Always use the ImageKit fallback URL.
    btn.innerHTML = '';
